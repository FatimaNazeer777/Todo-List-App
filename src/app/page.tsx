  ...
  return (
    ...
    >
      <div className="w-full max-w-xl bg-white rounded-3xl shadow-2xl p-6 border border-gray-200">
        <h1 className="text-2xl sm:text-4xl font-extrabold mb-6 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">
          Todo List App
        </h1>
        ...
        <div className="mb-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            ...
            >
              ...
              {["Work", "Personal", "Health", "Learning", "Finance"].map(
                (cat) => (
          ...
          <button
            onClick={addTodo}
            className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-2 px-4 rounded-xl text-sm sm:text-base hover:from-blue-600 hover:to-purple-700 transition duration-300"
          >
            Add Task
          </button>
        </div>
